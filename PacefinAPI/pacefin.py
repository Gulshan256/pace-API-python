...
if __name__ == "__main__":
    obj=Pacefin()
    # data=obj.generateSession("CSG981","Sarvam@123","123456")
    # print(data)
    # data=obj.getProfile("CSG981")
    # print(data)
    # data=obj.getFunds("CSG981")
    # print(data)
    # data=obj.getPendingOrderBook("CSG981")
    # print(data)
    # data=obj.getCompletedOrderBook("CSG981")
    # print(data)
    # data=obj.getTradedOrderBook("CSG981")
    # print(data)
    # print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    # getAllIPO=obj.getAllIPO()
    # print(getAllIPO)
    # getDemateHoldings=obj.getDemateHoldings("CSG981")
    # print(getDemateHoldings)
    # getPositionsNetwise=obj.getPositionsNetwise("CSG981")
    # print(getPositionsNetwise)
    # fetchBasket=obj.fetchBasket("CSG981")
    # print(fetchBasket)
    # renameBasket=obj.renameBasket({"basket_id":"64fa5b85-bf12-4ceb-9a87-08257abec49c","name":"hh"})
    # print(renameBasket)
    # createBasket=obj.createBasket({"login_id":"CSG981","name":"testgk","type":"NORMAL","product_type":"ALL","order_type":"ALL"})
    # print(createBasket)
